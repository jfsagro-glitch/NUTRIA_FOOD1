  ...
  const findProductByBarcode = async (inputCode: string): Promise<boolean> => {
    ...
    for (const code of candidates) {
      try {
        ...
        // Закрываем сам экран сканера, иначе он остаётся поверх карточки продукта: раньше
        // после успешного скана пользователь видел не карточку, а поле ручного ввода с
        // открытой клавиатурой (сканер не закрывался). Экран веса откроется вместо него.
